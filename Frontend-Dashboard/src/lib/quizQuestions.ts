...
export const QUIZ_QUESTIONS: QuizQuestionRow[] = [
  {
    "id": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "C) \"I need to know the system they used.\"",
      "D) \"I'm coming for that spot, and then some.\""
    ]
  },
  {
    "id": 3,
    "question": "[Section 1: The Diagnostic] When you see a \"Guru\" in a rented Lambo, what is your gut reaction?",
    "options": [
  ...
  {
    "id": 4,
    "question": "[Section 1: The Diagnostic] How do you feel when you see people from your area working a 9-to-5 until they're 65?",
    "options": [
      "A) It's a safe life; I just wish it paid more.",
      "B) It's depressing, but I don't see another way out.",
      "C) It's a trap, and I'll do anything to avoid being another statistic.",
      "D) It's a slave-ship. I'm building my own fleet."
    ]
  },
  {
    "id": 5,
  ...
  {
    "id": 7,
    "question": "[Section 2: The Strengths] Which of these \"System Glitches\" interests you most?",
    "options": [
      "A) Crypto markets and Blockchain loops.",
      "B) AI Agents and automated software bots.",
      "C) Faceless content and digital influence.",
      "D) Global logistics and automated publishing."
    ]
  },
  {
    "id": 8,
  ...
  {
    "id": 12,
    "question": "[Section 4: The Grind & Sacrifice] If you were given a \"Play\" that required 16 hours of work a day for a month, what's your move?",
    "options": [
      "A) I'd probably burn out after 3 days.",
      "B) I'd do it if I saw someone else do it first.",
      "C) I'd grind it out, but I'd be stressed the whole time.",
      "D) I already live like that; just give me the objective."
    ]
  },
  {
    "id": 13,
  ...
  {
    "id": 14,
    "question": "[Section 4: The Grind & Sacrifice] What is your current \"War Chest\" (Liquid Capital) for this transition?",
    "options": [
      "A) Under $100",
      "B) $100 - $500",
      "C) $500 - $2,500",
